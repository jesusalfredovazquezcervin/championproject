...
<html>
	...
	<body>
		<a href="#edit-recoveryLink" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-recoveryLink" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${recoveryLinkInstance?.version}" />
				<fieldset class="form">
