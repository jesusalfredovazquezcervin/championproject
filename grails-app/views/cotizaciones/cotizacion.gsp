...
<html>
	...
	<g:form action="sendCotizacion" controller="cotizaciones" >
	...
	<table style="width: 98%; margin-left: 1%; ">
		...
		<tr>
			<td colspan="4" id="mensaje" name="mensaje" style="text-align: right;"><g:submitButton name="Enviar cotización" /> </td>
		</tr>
	</table>
	</g:form>
