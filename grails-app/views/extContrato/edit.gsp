...
<html>
	<head>
		...
		<title><g:message code="extContrato.edit.label" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#edit-extContrato" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-extContrato" class="content scaffold-edit" role="main">
			<h1><g:message code="extContrato.edit.label" args="[entityName]" /></h1>
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${extContratoInstance?.version}" />
				<fieldset class="form">
