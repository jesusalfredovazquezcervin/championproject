...
<html>
	<head>
		...
		<title><g:message code="usuario.create.title" args="[entityName]" /></title>
	</head>
	<body>
		...
		<div id="create-usuario" class="content scaffold-create" role="main">
			<h1>
			<img src="${resource(dir: 'images/skin/batch_icons/64x64', file: 'user-4-add.png')}" alt="CHAMPION"/>
			<g:message code="usuario.create.title" args="[entityName]" /></h1>
