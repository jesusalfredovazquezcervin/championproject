...
<html>
	<head>
		...
		<title><g:message code="zona.create.title" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#create-zona" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-zona" class="content scaffold-create" role="main">
			<h1><g:message code="zona.create.title" args="[entityName]" /></h1>
